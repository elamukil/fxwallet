        ...
        <View style={styles.container}>
            <View style={styles.planHeaderWrap}>
                ...
                <View style={styles.payBtn}>
                    <Text style={styles.price}>100000 MMK</Text>
                </View>
            </View>
            <View style={styles.detailsWrap}>
                <Text style={styles.detailsText}>JIO Diwali Celebration Offer - 75GB data + Coupons from Reliance Digital, AJIO, ixigo, Ferns N Petals,Urban Ladder & Zoomin</Text>
            </View>
