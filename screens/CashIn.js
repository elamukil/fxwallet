 ...
 * -----                                                                       *
 * Last Modified: November 11th 2022, 2:58:42 pm                               *
    ...
    <View style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        <View style={styles.optionItem}>
          <Text onPress={() => navigation.navigate('cashin2',{phoneNumber:route.params.phoneNumber, pin: route.params.pin})} style={styles.optionText}>Agent / Merchant</Text>
